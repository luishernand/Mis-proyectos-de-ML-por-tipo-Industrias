...
## Conjunto de Datos 
para este proyecto bajamos los datos de [kaggle](https://www.kaggle.com/mathchi/churn-for-bank-customers),. El conjunto de datos consta de **10,000** observaciones y **13** características
