...
Aplicamos modelos tanto de machine learning como Deep learning para este conjunto de datos muy desbalanceado. Es muy frecuente encontrarnos con datasets con clases desbalanceadas, de hecho… lo más raro sería encontrar datasets bien equilibrados, aplicamos diversas estrategias a seguir para combatir esta problemática: eliminar muestras del set mayoritario, crear muestras sintéticas con algún criterio, ensamble y penalización. 
